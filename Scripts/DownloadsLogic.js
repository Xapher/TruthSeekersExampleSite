...
function PopulateDownloads(){
	...
	DownloadContainer.innerHTML += "<button onclick=\"this.children[0].click()\" class=\"DownloadCard\"><a download style=\"display:none;\" href=\"" + DownloadJSON["Answers"] + "\">Download Eval Answer Sheets</a><p>Answer Sheet: #" + SelectedLesson + "</p><img src=\"./Content/Images/EvalDownload.png\"><img src=\"./Content/Images/DownloadButton.png\"></button>";
