...
function PopulateDownloads(){
	...
	DownloadContainer.innerHTML += "<button onclick=\"this.children[0].click()\" class=\"DownloadCard\"><a download style=\"display:none;\" href=\"" + DownloadJSON["Diagram"] + "\">Download Transcript</a><p>Transcipt: #" + SelectedLesson + "</p><img src=\"./Content/Images/TranscriptDownload.png\"><img src=\"./Content/Images/DownloadButton.png\"></button>";
	...
	DownloadContainer.innerHTML += "<button onclick=\"this.children[0].click()\" class=\"DownloadCard\"><a download style=\"display:none;\" href=\"" + DownloadJSON["Answers"] + "\">Download Eval Answer Sheets</a><p>Answer Sheet: #" + SelectedLesson + "</p><img src=\"./Content/Images/AnswerDownload.png\"><img src=\"./Content/Images/DownloadButton.png\"></button>";
